...
public actual class Solver(internal val native: Z3_solver, internal val context: Context) : Z3Object() {
...
public actual class Model(internal val native: Z3_model, internal val context: Context) : Z3Object() {
    ...
    public actual fun <R : Sort> getFuncInterp(funcDecl: FuncDecl<R>): FuncInterp<R>? = Z3_model_get_func_interp(context.native, native, funcDecl.native)?.let(::FuncInterp)
...
public actual class Optimize(internal val native: Z3_optimize, internal val context: Context) : Z3Object() {
...
public actual class Statistics(internal val native: Z3_stats, internal val context: Context) : Z3Object() {
